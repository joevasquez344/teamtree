  ...
  return (
    <>
      {messages?.length === 0 && !chatLoading ? (
        ...
        <div
          className={` relative flex flex-col  space-y-3 pt-2 transition ease-in-out cursor-pointer duration-500  h-screen overflow-y-scroll no-scrollbar pb-52 md:pb-64`}
        >
