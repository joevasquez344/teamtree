  ...
  return (
    <>
      {messages?.length === 0 && !chatLoading ? (
        ...
        <div
          className={` relative flex h-screen flex-col space-y-3 pt-2 transition ease-in-out cursor-pointer duration-500 overflow-y-scroll no-scrollbar pb-64 md:pb-64`}
        >
